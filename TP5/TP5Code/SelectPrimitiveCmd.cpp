...
void SelectPrimitiveCmd::execute()
{
	...
	VisitorPrimitiveSelector visitorPrimitiveSelector(m_type);
	m_obj3d.accept(visitorPrimitiveSelector);
	visitorPrimitiveSelector.getSelectObjects(m_selectObjContainer);
}
